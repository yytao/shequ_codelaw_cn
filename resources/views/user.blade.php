        ...
        <div><div data-v-cf2da122="" class="user-center-wrap">
                <div data-v-178e9d9c="" data-v-cf2da122="" class="user-card-nav-wrap">
                    ...
                    <div data-v-178e9d9c="" class="user-info"><div data-v-178e9d9c="" class="user-name"> 墙外楼_BI1FPF
                        ...
                        <div data-v-178e9d9c="" class="user-sign">{{ trans('user.empty_intro') }}</div>
                    </div><!---->
                </div>
                <ul data-v-cf2da122="" class="user-center-ul">
                    <li data-v-cf2da122="">
                        <div data-v-5b06c658="" data-v-cf2da122="" class="nav-title-wrap">
                            ...
                            <span data-v-5b06c658="">{{ trans('user.my_post') }}</span>
                    ...
                    <li data-v-cf2da122="">
                        <div data-v-5b06c658="" data-v-cf2da122="" class="nav-title-wrap">
                            ...
                            <span data-v-5b06c658="">{{ trans('user.my_collect') }}</span>
                            <svg data-v-5b06c658="" class="nav-title-more-icon">
                                <path fill-rule="evenodd" d="M4.646 1.646a.5.5 0 0 1 .708 0l6 6a.5.5 0 0 1 0 .708l-6 6a.5.5 0 0 1-.708-.708L10.293 8 4.646 2.354a.5.5 0 0 1 0-.708z"/>
                            </svg>
                        </div>
                    ...
                    <li data-v-cf2da122="">
                        <div data-v-5b06c658="" data-v-cf2da122="" class="nav-title-wrap">
                            ...
                            <span data-v-5b06c658="">{{ trans('user.report') }}</span>
                            <svg data-v-5b06c658="" class="nav-title-more-icon">
                                <path fill-rule="evenodd" d="M4.646 1.646a.5.5 0 0 1 .708 0l6 6a.5.5 0 0 1 0 .708l-6 6a.5.5 0 0 1-.708-.708L10.293 8 4.646 2.354a.5.5 0 0 1 0-.708z"/>
                            </svg>
                        </div>
            ...
            <div data-v-502af113="" class="log-out-wrap"> {{ trans('user.logout') }} </div>
        </div>
    </div>
